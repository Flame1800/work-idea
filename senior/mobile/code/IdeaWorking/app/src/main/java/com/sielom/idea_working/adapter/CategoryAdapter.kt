...
class CategoryAdapter(val inflater: LayoutInflater) :
    ListAdapter<Category, CategoryAdapter.CategoryHolder>(object :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryHolder {
        return CategoryHolder(inflater.inflate(R.layout.item_category, parent, false))
    }
    ...
    inner class CategoryHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val removeCategoryImageView: ImageView =
            itemView.findViewById(R.id.removeCategoryImageView)
